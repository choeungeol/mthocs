...
@section('css')
    ...
    <link rel="stylesheet" type="text/css"
          href="vendor/assets/vendors/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css">
    ...
    <link rel="stylesheet" type="text/css"
          href="vendor/assets/vendors/datatables/media/css/dataTables.bootstrap4.min.css">
